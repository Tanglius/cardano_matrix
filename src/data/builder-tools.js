...
export const Showcases = [
  {
    ...
    website:
      "https://github.com/IntersectMBO/cardano-node/tree/master/cardano-cli#cardano-cli",
    getstarted: null,
    releases: [
      {
        version: "3.1.2",
    ...
    releases: [
      {
        version: "3.1.2",
        latest: true,
        dependencies: ["cardano-node", "cardano-cli"],
        traits: ["babbage", "alonzo", "cip31", "cip32"],
      },
      {
        version: "3.1.1",
  ...
  },
  {
    ...
    getstarted:
      "https://github.com/cardano-foundation/cardano-graphql#getting-started",
    releases: [
      {
        version: "3.1.2",
        latest: true,
        dependencies: ["cardano-db-sync", "cardano-node"],
        traits: ["babbage", "alonzo", "cip31", "cip32"],
      },
      {
        version: "3.1.1",
        dependencies: ["cardano-db-sync"],
        traits: ["alonzo"],
      },
    ],
  ...
  },
  {
    ...
    description:
      "An implementation of Rosetta for Cardano to simplify blockchain integration.",
    preview: require("./builder-tools/cardano-rosetta.png"),
    website:
      "https://github.com/cardano-foundation/cardano-rosetta/#cardano-rosetta",
    getstarted: "https://www.rosetta-api.org/docs/getting_started.html",
    releases: [
      {
        version: "3.1.2",
        latest: true,
        dependencies: ["cardano-node", "cardano-db-sync"],
        traits: ["babbage", "alonzo", "cip31", "cip32"],
      },
      {
        version: "3.1.1",
  ...
  },
  {
    ...
    description:
      "A PostgreSQL database layer that stores Cardano blockchain data in a structured format.",
  ...
  },
  {
    ...
    getstarted:
      "https://github.com/IntersectMBO/cardano-addresses#command-line",
    releases: [
      {
        version: "3.1.2",
        latest: true,
  ...
  },
  {
    ...
    description:
      "CLI scripts to manage your stake pool (online or offline), use and migrate to hardware wallets, send transactions, and more.",
    ...
    releases: [
      {
        ...
        latest: true,
        dependencies: ["cardano-cli"],
        traits: ["babbage", "alonzo", "cip31", "cip32", "plutus"],
      },
      {
        version: "3.1.1",
        dependencies: ["cardano-cli"],
        traits: ["alonzo", "plutus"],
      },
    ],
    ...
    releases: [
      {
        ...
        latest: true,
        dependencies: ["cardano-cli"],
        traits: ["babbage", "alonzo", "cip31", "cip32", "marlowe"],
      },
      {
        version: "3.1.1",
        dependencies: ["cardano-cli"],
        traits: ["alonzo", "marlowe"],
      },
    ],
    ...
    releases: [
      {
        ...
        traits: ["babbage", "alonzo", "cip31", "cip32", "plutus", "nft"],
      },
      {
        version: "3.1.1",
        dependencies: ["plutus", "cardano-cli"],
    ...
    releases: [
      {
        version: "3.1.2",
        latest: true,
        dependencies: ["cardano-serialization-lib", "cardano-cli"],
        traits: ["babbage", "alonzo", "cip31", "cip32"],
      },
      {
        version: "3.1.1",
  ...
  },
  {
    title: "Lucid",
    description:
      "Lucid is a library that allows you to create Cardano transactions and off-chain code for your Plutus contracts in JavaScript and Node.js.",
    ...
    releases: [
      {
        ...
        latest: true,
        dependencies: ["cardano-node"],
        traits: ["babbage", "alonzo", "cip31", "cip32", "plutus", "aiken"],
      },
      {
        version: "3.1.1",
        dependencies: ["cardano-node"],
        traits: ["alonzo", "plutus", "aiken"],
      },
    ],
  ...
  },
  {
    title: "Mesh SDK",
    description:
      "An Open-Source library by Martify Labs with the purpose of making building dApps on Cardano easier than ever.",
  ...
  },
  {
    title: "Hydra",
    description:
      "Hydra is the layer-two scalability solution for Cardano, which aims to increase the speed of transactions and minimize transaction cost.",
